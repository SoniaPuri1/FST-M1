...
SORT BY DIDTINCT CUSTOMER_ID;

SELECT CUSTOMER_ID, MAX(PURCHASE_AMOUNT) FROM ORDERS 
SORT BY DISTINCT CUSTOMER_ID;
...
SELECT CUSTOMER_ID, MAX(CUSTOMER_ID) FROM ORDERS 
...
WHERE ORDER_DATE = TO DATE (2012-08-17) 
...
SELECT SALESMAN_ID, MAX(PURCHASE_AMOUNT) FROM ORDERS 
WHERE ORDER_DATE = TO DATE ('2012-08-17', 'YYYY-MM-DD') 
GROUP BY SALESMAN_ID;
